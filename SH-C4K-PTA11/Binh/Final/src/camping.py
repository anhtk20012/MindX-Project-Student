...
class Camping (QMainWindow):
    def __init__(self, signal=None):
        super().__init__()
        os.chdir(Path(__file__).parent)
        self.ui = uic.loadUi('../ui/Camping.ui', self)
        ...
        self.ui.pushButton_6.clicked.connect(self.yellowstoneNationalPark_show)
        self.ui.pushButton_10.clicked.connect(self.moraineLake_show)
        self.ui.pushButton_9.clicked.connect(self.wadiRum_show)
        self.ui.pushButton_12.clicked.connect(self.jotunheimen_show)
        self.ui.pushButton_7.clicked.connect(self.close_application)
        self.ui.pushButton_8.clicked.connect(self.menu_show)
        
    def camping_open(self):
        self.show()
