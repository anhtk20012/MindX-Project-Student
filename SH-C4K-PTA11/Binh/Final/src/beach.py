...
class Beach (QMainWindow):
    def __init__(self, signal=None):
        super().__init__()
        os.chdir(Path(__file__).parent)
        self.ui = uic.loadUi('../ui/Beaches.ui', self)
        ...
        self.ui.pushButton_6.clicked.connect(self.whiteBeach_show)
        self.ui.pushButton_10.clicked.connect(self.mayaBay_show)
        self.ui.pushButton_12.clicked.connect(self.navagioBeach_show)
        self.ui.pushButton_9.clicked.connect(self.nusaDua_show)
        self.ui.pushButton_11.clicked.connect(self.close_application)
