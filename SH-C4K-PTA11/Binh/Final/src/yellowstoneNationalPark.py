...
class YellowstoneNationalPark (QMainWindow):
    def __init__(self, signal=None):
        super().__init__()
        os.chdir(Path(__file__).parent)
        self.ui = uic.loadUi('../ui/YellowstoneNationalPark.ui', self)
        ...
        self.ui.pushButton_3.clicked.connect(self.camping_show)
        self.ui.pushButton.clicked.connect(self.success_show)
    def yellowstoneNationalPark_open(self):
        self.show()
...
#    windows = YellowstoneNationalPark()
#    windows.show()
#    app.exec()
