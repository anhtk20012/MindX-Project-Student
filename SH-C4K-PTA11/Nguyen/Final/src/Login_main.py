...
class main_login(QMainWindow):
    def __init__(self, signal=None):
        ...
        self.ui.pushButton_2.clicked.connect(self.main_register_show)
        
    def main_login_open(self, position):
        self.show()
        self.move(position)

    def main_register_show(self):
        self.clean_text()
        self.close()
        self.signal.main_register.emit(self.pos())
